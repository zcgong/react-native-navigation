...
Pass a function that will allow you to register a component lazily. When encountering an unknown component name, this function will be called, gaiving you a chance to register the component before an error is thrown.a
